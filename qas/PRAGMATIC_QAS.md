...
### Why anchor access to **energy expenditure** instead of identity?  
...
### How does LOCK compare with **Lightning paywalls**?  
...
### Could governments **ban** LOCK-gated content?  
...
### Will this incentivise **spam transactions**?  
...
### Does LOCK threaten **permissionless culture** by pay-walling knowledge?  
...
### How might LOCK bolster **Bitcoin circular economies**?  
...
### Is there a risk of **consolidation** into closed marketplaces?  
...
### Could LOCK undermine **open-source** culture?  
...
### Will miners capture **MEV** from high-value unlocks?  
...
### Could LOCK facilitate **dark markets**?  
...
### Is LOCK a step toward **“Internet 1995, but with money built-in”**?  
