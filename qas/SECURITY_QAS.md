...
### How does the protocol handle **Replace-By-Fee** attacks?  
...
### Could an attacker perform a **replay attack** across vaults?  
...
### Is the protocol vulnerable to **side-channel leaks** like ciphertext length?  
...
### How to deal with **chain re-orgs**?  
...
### Could miners **censor** high-value unlocks for ransom?  
...
### What is a **fee sniping** vector and how to prevent it?  
...
### How does the spec avoid **insecure random** generation?  
...
### Could a malicious host serve a **corrupted SEAL**?  
...
### What about **DoS** vectors on public gateways?  
...
### Is there a **key compromise** escalation path?  
...
### Does LOCK introduce new **privacy leaks** on-chain?  
...
### Can malicious wallets create **dust fallout**?  
...
### What if the **recipient address** is compromised?  
...
### Are **hash collisions** a threat for SEAL IDs?  
...
### Is there any risk of **timing side-channels** in decryption?  
